export default function Page() {
  return (
    <div className="mx-10 my-10">
      ...
      <p>
        {" "}
        Economic euthanasia is a reality. The cost of the required care exceeds
        what the pet owner can afford. To keep the pet from suffering, the pet
        is euthanized. What if there was an option?
      </p>
      <p>
        {" "}
        A portion of all sales will be added to this program. Any vet can call
        and request funding for surgery or medical procedures to avoid economic
        euthanasia. This is not a loan to the pet owner. It is given freely
        based on funds available on a first come, first served basis.
      </p>
      <p>
        {" "}
