export default function Page() {
  return (
    <div className="mx-10 my-10">
      ...
      <p className="mt-5">
        When I lost Sadie in 2015, and Cali in 2017, I was devastated. Crippled.
        I couldn’t work. I had days that I couldn’t even get out of bed. I lost
        a business after 25 years. I lost the apartment I had lived in for 20
        years. I was homeless for about 2 years (with a little couch-surfing
        when someone would take me in).
      </p>
      <p className="mt-5">
      ...
      <p className="mt-5">
        We do not have such a language for each other when we lose a pet, even
        though for some, like me, the experience is equally devastating.
      </p>{" "}
      <p className="mt-5">
